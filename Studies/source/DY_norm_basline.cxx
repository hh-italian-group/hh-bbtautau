...
private:
    ...
    std::map<EventCategory,std::string> eventCategories{ {  EventCategory::TwoJets_ZeroBtag(), "2j0b"} ,

        {EventCategory::TwoJets_TwoBtagPlus(), "2j2b"},
                                                       { EventCategory::TwoJets_OneBtag(), "2j1b" }};
