...
public:
    ...
    std::string GetFileName(size_t signal_point) const { return ResolvePattern(file_path_pattern, signal_point); }
    std::string GetDatacardName(size_t signal_point) const { return ResolvePattern(datacard_name, signal_point); }
    std::string GetPointName(size_t signal_point) const { return ResolvePattern(name_suffix, signal_point); }
    std::string GetFullName(size_t signal_point) const { return name + "_" + GetPointName(signal_point); }
