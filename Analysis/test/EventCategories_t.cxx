...
BOOST_AUTO_TEST_CASE(determine_ec_1)
{
    ...
    const boost::optional<analysis::DiscriminatorWP> vbf_wp;
    BOOST_TEST(EC::Parse("Inclusive").Contains(1, btags, false, false, vbf_wp));
    BOOST_TEST(EC::Parse("0j").Contains(1, btags, false, false, vbf_wp));
    BOOST_TEST(EC::Parse("1j").Contains(1, btags, false, false, vbf_wp));
    BOOST_TEST(EC::Parse("1j0b").Contains(2, btags, false, false, vbf_wp));
    BOOST_TEST(EC::Parse("1j0b+").Contains(1, btags, false, false, vbf_wp));
    BOOST_TEST(EC::Parse("2j").Contains(2, btags, false, false, vbf_wp));
    BOOST_CHECK_THROW(EC::Parse("2j1LbR_VBF").Contains(2, btags, true, false, vbf_wp), analysis::exception);
}
...
BOOST_AUTO_TEST_CASE(determine_ec_2)
{
    ...
    const boost::optional<analysis::DiscriminatorWP> vbf_wp;
    BOOST_TEST(EC::Parse("1j1b+").Contains(3, btags, false, false, vbf_wp));
    BOOST_TEST(EC::Parse("Inclusive").Contains(3, btags, false, false, vbf_wp));
    BOOST_TEST(EC::Parse("0j").Contains(3, btags, false, false, vbf_wp));
    BOOST_TEST(EC::Parse("3j3LbR_noVBF").Contains(3, btags, false, false, vbf_wp));
    BOOST_TEST(EC::Parse("2j2b+").Contains(3, btags, false, false, vbf_wp));
    BOOST_TEST(EC::Parse("2j2b").Contains(3, btags, false, false, vbf_wp));
    BOOST_TEST(EC::Parse("2j1b+R").Contains(3, btags, false, false, vbf_wp));
    BOOST_TEST(EC::Parse("2j2b+R_noVBF").Contains(3, btags, false, false, vbf_wp));
    BOOST_TEST(!EC::Parse("2j0b").Contains(3, btags, false, false, vbf_wp));
    BOOST_TEST(EC::Parse("2j2b+_noVBF").Contains(3, btags, false, false, vbf_wp));
    BOOST_TEST(!EC::Parse("2j2b_VBF").Contains(3, btags, false, false, vbf_wp));
    BOOST_TEST(EC::Parse("2j2b").Contains(3, btags, false, false, vbf_wp));
}
