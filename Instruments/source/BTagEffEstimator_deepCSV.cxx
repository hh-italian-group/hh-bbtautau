...
class BTagEfficiency_deepCSV {
public:
    using Event = ntuple::Event;
    using EventTuple = ntuple::EventTuple;

    BTagEfficiency_deepCSV(const Arguments& _args) :
    ...
    void Run()
    {
        ...
        static const std::map<std::string, double> btag_working_points = { { "L", cuts::btag_2017::deepCSVv2L },
            ...
            for (const auto& name : args.input_file()){
                ...
                for(const Event& event : *tuple){
                    ...
                    for (size_t i = 0; i < event.jets_p4.size(); ++i){
                        ...
                        double jet_deepcsv = event.jets_deepCsv_BvsAll.at(i);
...
PROGRAM_MAIN(analysis::BTagEfficiency_deepCSV, Arguments) // definition of the main program function
