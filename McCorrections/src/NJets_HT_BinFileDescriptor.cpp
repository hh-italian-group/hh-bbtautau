...
NJets_HT_BinFileDescriptor::NJets_HT_BinFileDescriptor() :
    n_jet(0,0), n_bjet(0,0),n_ht(0,0),nu(0.0, std::numeric_limits<double>::infinity()),
    weight(std::numeric_limits<double>::quiet_NaN())
{
}

bool NJets_HT_BinFileDescriptor::Contains(const ntuple::GenId& genId) const
{
...
std::vector<NJets_HT_BinFileDescriptor> NJets_HT_BinFileDescriptor::LoadConfig(const std::string& config_file)
{
...
std::ofstream NJets_HT_BinFileDescriptor::SaveCfg(const std::string& output_file,
