...
const std::string& WeightProvider::PangeaName() { static const std::string name = "pangea"; return name; }
const std::string& WeightProvider::AllEventTupleName() { static const std::string name = "pangea"; return name; }

WeightProvider::WeightProvider(const std::string& param_cfg_name, TFile* file)
{
...
void WeightProvider::AddFile(TFile& file)
{
...
void WeightProvider::CreatePdfs(TFile* file)
{
    CheckOverflows();
...
void WeightProvider::SetTargetPoint(const Point& _point)
{
    point = _point;
...
double WeightProvider::Get(double lhe_hh_m, double lhe_hh_cosTheta) const
{
    if(!has_pdf)
        throw exception("Pangea pdf is not created.");

    double m_hh = lhe_hh_m;
    double cos_theta = std::abs(lhe_hh_cosTheta);
...
void WeightProvider::CheckOverflows() const
{
...
void WeightProvider::ReadParameterizationConfig(const std::string& param_cfg_name)
{
